...
// It also creates the vncSockConnect server, which allows connections via 
// sockets.
...
public:
	...
	virtual vncClientId AddClient(VSocketBase *socket, BOOL reverse, BOOL shared);
	virtual vncClientId AddClient(VSocketBase *socket, BOOL reverse, BOOL shared,
...
public:
	...
	// XMPP account.
	virtual std::string GetXmppUsername() { return m_xmpp_username; }
	virtual void SetXmppUsername(std::string username) { m_xmpp_username = username; }
	virtual std::string GetXmppPassword() { return m_xmpp_password; }
	virtual void SetXmppPassword(std::string password) { m_xmpp_password = password; }
...
protected:
	...
	// XMPP preferences
	std::string m_xmpp_username;
	std::string m_xmpp_password;
