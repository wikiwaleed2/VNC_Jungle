...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, PSTR szCmdLine, int iCmdShow)
{
	...
	for (i = 0; i < strlen(szCmdLine); i++)
	{
		...
		MessageBox(NULL, winvncUsageText, "RemoteVNC Usage", MB_OK | MB_ICONINFORMATION);
		break;
	}
...
int WinVNCAppMain()
{
	...
	if (!instancehan.Init())
	{
		...
		MessageBox(NULL, "Another instance of RemoteVNC is already running", szAppName, MB_OK);
		return 0;
	}
