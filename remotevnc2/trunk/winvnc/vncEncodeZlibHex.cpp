...
UINT
vncEncodeZlibHex::EncodeRect(BYTE *source, VSocketBase *outConn, BYTE *dest, const RECT &rect, int offx, int offy)
{
...
vncEncodeZlibHex::EncodeHextiles##bpp(BYTE *source, BYTE *dest,				\
				  VSocketBase *outConn, int rx, int ry, int rw, int rh)			\
{																			\
    int x, y, w, h;															\
