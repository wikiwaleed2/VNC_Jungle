...
public:
	...
	static BOOL CALLBACK AccountDlgProc(HWND hwnd, UINT uMsg, WPARAM wParam, LPARAM lParam);
...
protected:
	...
	void SaveString(HKEY key, const char *entry_name, std::string value);
	std::string LoadStdString(HKEY key, const char *entry_name);
...
private:
	...
	AccountControls * m_AccountControls;
