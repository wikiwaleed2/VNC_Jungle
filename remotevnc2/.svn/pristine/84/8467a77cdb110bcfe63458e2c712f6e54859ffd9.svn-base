...
public:
	...
	virtual UINT EncodeRect(BYTE *source, VSocketBase *outConn, BYTE *dest, const RECT &rect, int offx, int offy);
...
protected:
	...
	UINT EncodeRectSimple (BYTE *source, VSocketBase *outConn, BYTE *dest,
						   const RECT &rect);
	UINT EncodeSubrect    (BYTE *source, VSocketBase *outConn, BYTE *dest,
