...
UINT
vncEncodeTight::EncodeRect(BYTE *source, VSocketBase *outConn, BYTE *dest,
...
UINT
vncEncodeTight::EncodeRectSimple(BYTE *source, VSocketBase *outConn, BYTE *dest,
								 const RECT &rect)
{
...
UINT
vncEncodeTight::EncodeSubrect(BYTE *source, VSocketBase *outConn, BYTE *dest,
